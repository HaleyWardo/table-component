      ...
      return (
        <>
          <div>
            ...
            />
            {selectedFiles.length ? `Selected ${selectedFiles.length}`: 'None Selected'}
            <Button icon={Download} onClick={() => onDownload?.(selectedFiles)}>Download Selected</Button>
          </div>
            ...
            <TableBody>
              {!!files.length ? files.map((file) => (
                <TableRow key={file.name}>
                  ...
                  <TableDataCell>{file.status}</TableDataCell>
                </TableRow>
              )) :
                <TableRow>
